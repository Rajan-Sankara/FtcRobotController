...
@Autonomous(name = "HuskyLensTeleOp", group = "Vision")
public class Auto_RedBlue_TOP extends LinearOpMode {
...
// Rotate for 1 second (adjust as needed)
...
// Stop motors
            ...
            servo.setPosition(0.9);// extend / drop
            sleep(750);

            servo.setPosition(0.01);// extend / drop
            sleep(750);
